...
#define DHT11_Dout_PIN GPIO_PIN_1
/***********************   DHT11 函数宏定义  ****************************/
#define DHT11_Dout_LOW()                                                       \
  HAL_GPIO_WritePin(DHT11_Dout_PORT, DHT11_Dout_PIN, GPIO_PIN_RESET)
#define DHT11_Dout_HIGH()                                                      \
  HAL_GPIO_WritePin(DHT11_Dout_PORT, DHT11_Dout_PIN, GPIO_PIN_SET)
